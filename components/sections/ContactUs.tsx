...
//   );
// }
// cal_live_c89f5f62304db955ec2dce62df556db6
  ...
  return (
    <div id="contact" className="App">
      <div className="heading">
        ...
        <div>
          <div className="w-full text-center">
            ...
            <div className="text-base sm:text-lg px-6 pt-4 pb-10">
              <p>Whether you have a question about our services,
              pricing, or anything else, our team is ready
      ...
      <div className="cal-wrapper">
        <Cal calLink="kevin-92be6h/30min" config={{ theme: "light" }}></Cal>
      </div>{" "}
    </div>
  );
}
